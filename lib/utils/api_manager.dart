...
import 'package:patient_dev/utils/get_streamed_response.dart';
import 'package:patient_dev/utils/uploaded_file.dart';
...
class ApiManager {
  ...
  static Future<ApiCallResponse> requestWithBody(
    ...
    print('APIREQ apiUrl ${response.request?.url ?? '-'} ${response.body}');
    return ApiCallResponse.fromHttpResponse(response, returnBody, decodeUtf8);
  }
